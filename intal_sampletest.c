...
int main(int argc, char const *argv[]) {
	...
	// result1 = intal_multiply("1","2");
	//     string str1 = "1235421415454545454545454544"; 
 //    string str2 = "1714546546546545454544548544544545"
 //    result1 = intal_multiply("1235421415454545454545454544","1714546546546545454544548544544545");
	if(!result1) {
